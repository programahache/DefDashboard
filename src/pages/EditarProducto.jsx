...
import { updateproductos, getproductosById } from '../../utils/productos';
...
function EditarProducto() {
    ...
    const id = window.location.pathname.split('/').pop(); // Suponiendo que el ID está al final de la URL

    useEffect(() => {
        // Obtener el ID del producto desde la URL o desde donde lo estés pasando
        ...
        getproductosById(id)
            .then((data) => {
                ...
                setProducto({
                    ...data,
                    imagen: data.imagen || 'trucha.jpg', // Asignar una imagen por defecto si no hay
                });
            })
            .catch((error) => {
    ...
    return (
        <div className='w-full h-full flex flex-col gap-5 p-5'>
            <h1 className='text-4xl text-gray-100 font-bold'>Actualizar Producto</h1>
