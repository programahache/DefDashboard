...
function Modal({ isModal }) {
  return (
    <>
      {isModal ?? (
        <div className=" modal h-screen w-screen absolute flex   items-center justify-center top-0 left-0 overflow-x-hidden overflow-y-auto  ">
          <div className="h-2/4 w-1/3 bg-white p-2 rounded-xl flex flex-col gap-5">
            {/* --HEADER DEL MODAL */}
            <div className="modal-header flex items-center justify-between ">
              <div className="">
                <h1 className="font-bold">Pedido #35604</h1>
              </div>

              <button className="bg-red-200 px-3 py-1 rounded-full text-center ">
                x
              </button>
